...
VOLL           = 1000;    
LINE_PENALTY   = 5000;    
scenario_name     = 'Scenario5_Modern_Grid_BNM';                  
current_wind_caps = [75, 75, 400]; % [Bus 7 DER, Bus 13 DER, Bus 21 Bulk]
chosen_tmax    = 75;               
EXCEEDANCE_SLR = 0.01;             
...
% Standard MATPOWER PMIN adjustment (Pmin = 10% of Pmax)
...
fprintf('\n======================================================\n');
fprintf(' 🎉 SCENARIO 5 (BNM) COMPLETE WITH FULL TRACKING. Total Time: %.2f seconds\n', elapsed_time);
fprintf('======================================================\n');
