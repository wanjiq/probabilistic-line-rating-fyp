...
VOLL           = 1000;    
LINE_PENALTY   = 5000;    
scenario_name     = 'Scenario3_Bulk_Integrated_BNM';                  
current_wind_caps = [75, 75, 400]; % Bulk Wind Heavy (400MW at Bus 21)
chosen_tmax    = 75;               
EXCEEDANCE_SLR = 0.01;             
...
fprintf('\n======================================================\n');
fprintf(' 🎉 SCENARIO 3 (BNM) COMPLETE WITH FULL TRACKING. Total Time: %.2f seconds\n', elapsed_time);
fprintf('======================================================\n');
